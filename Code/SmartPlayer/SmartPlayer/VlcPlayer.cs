...
namespace SmartPlayer
{
    class VlcPlayer
    {
        private IntPtr libvlc_instance_; // libvlc实例地址
        private IntPtr libvlc_media_player_; // libvlc media player实例地址
        private double duration_;
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="pluginPath">plugin目录</param>
        ...
        {
            LibVlcAPI.libvlc_media_player_set_rate(libvlc_media_player_, rate);
        }
